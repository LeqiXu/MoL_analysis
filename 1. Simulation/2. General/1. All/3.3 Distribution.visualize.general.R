...
tableDir= '/Users/xuleqi/Desktop/Research/Project/Count_Data_GWAS_Project：MoL/Result/Simulation/General/Table/Distribution/original/'
figureDir= '/Users/xuleqi/Desktop/Research/Project/Count_Data_GWAS_Project：MoL/Result/Simulation/General/Figure/Distribution/original/'
...
norm_var_dist_0.25$n <- ordered(norm_var_dist_0.25$n, levels = c("n = 200", "n = 500", "n = 1000", "n = 2000","n = 5000"))
norm_var_dist_0.25$p <- paste0("p = ",norm_var_dist_0.25$p)
norm_var_dist_0.25$p <- ordered(norm_var_dist_0.25$p, levels = c("p = 500", "p = 1000", "p = 2000", "p = 5000","p = 10000"))
norm_var_dist_0.25$z <- rep(qnorm(ppoints(100)),25)

#norm_var_dist_0.25 = norm_var_dist_0.25[which(norm_var_dist_0.25$p %in% c("p = 500","p = 10000")),]
...
norm_var_dist_1_11$n <- ordered(norm_var_dist_1_11$n, levels = c("n = 200", "n = 500", "n = 1000", "n = 2000","n = 5000"))
norm_var_dist_1_11$p <- paste0("p = ",norm_var_dist_1_11$p)
norm_var_dist_1_11$p <- ordered(norm_var_dist_1_11$p, levels = c("p = 500", "p = 1000", "p = 2000", "p = 5000","p = 10000"))
...
norm_var_dist_0.6$n <- ordered(norm_var_dist_0.6$n, levels = c("n = 200", "n = 500", "n = 1000", "n = 2000","n = 5000"))
norm_var_dist_0.6$p <- paste0("p = ",norm_var_dist_0.6$p)
norm_var_dist_0.6$p <- ordered(norm_var_dist_0.6$p, levels = c("p = 500", "p = 1000", "p = 2000", "p = 5000","p = 10000"))
...
norm_var_dist_0.2$n <- ordered(norm_var_dist_0.2$n, levels = c("n = 200", "n = 500", "n = 1000", "n = 2000","n = 5000"))
norm_var_dist_0.2$p <- paste0("p = ",norm_var_dist_0.2$p)
norm_var_dist_0.2$p <- ordered(norm_var_dist_0.2$p, levels = c("p = 500", "p = 1000", "p = 2000", "p = 5000","p = 10000"))
...
mix_var_dist_0.25$n <- ordered(mix_var_dist_0.25$n, levels = c("n = 200", "n = 500", "n = 1000", "n = 2000","n = 5000"))
mix_var_dist_0.25$p <- paste0("p = ",mix_var_dist_0.25$p)
mix_var_dist_0.25$p <- ordered(mix_var_dist_0.25$p, levels = c("p = 500", "p = 1000", "p = 2000", "p = 5000","p = 10000"))
...
mix_var_dist_1_11$n <- ordered(mix_var_dist_1_11$n, levels = c("n = 200", "n = 500", "n = 1000", "n = 2000","n = 5000"))
mix_var_dist_1_11$p <- paste0("p = ",mix_var_dist_1_11$p)
mix_var_dist_1_11$p <- ordered(mix_var_dist_1_11$p, levels = c("p = 500", "p = 1000", "p = 2000", "p = 5000","p = 10000"))
...
mix_var_dist_0.6$n <- ordered(mix_var_dist_0.6$n, levels = c("n = 200", "n = 500", "n = 1000", "n = 2000","n = 5000"))
mix_var_dist_0.6$p <- paste0("p = ",mix_var_dist_0.6$p)
mix_var_dist_0.6$p <- ordered(mix_var_dist_0.6$p, levels = c("p = 500", "p = 1000", "p = 2000", "p = 5000","p = 10000"))
...
mix_var_dist_0.2$n <- ordered(mix_var_dist_0.2$n, levels = c("n = 200", "n = 500", "n = 1000", "n = 2000","n = 5000"))
mix_var_dist_0.2$p <- paste0("p = ",mix_var_dist_0.2$p)
mix_var_dist_0.2$p <- ordered(mix_var_dist_0.2$p, levels = c("p = 500", "p = 1000", "p = 2000", "p = 5000","p = 10000"))
